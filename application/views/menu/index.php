          		...
          		<table class="table table-hover">
      				...
      				?>
          				<tr>
          					...
          					<td><?= $m->menu ?></td>
          					<td>
          						<a href="<?= base_url('menu/edit/').$m->id ?>" class="btn btn-info">Edit</a>
          						<a href="<?= base_url('menu/delete/').$m->id ?>" onclick="return confirm('Yakin menu dihapus?')" class="btn btn-danger">Delete</a>
          					</td>
          				</tr>
          			<?php endforeach ?>
          			</tbody>
